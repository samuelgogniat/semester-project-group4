...
layers <- st_layers("posmo_data/SWISSTLM3D_2023_LV95_LN02.gpkg")

roads <- read_sf("posmo_data/SWISSTLM3D_2023_LV95_LN02.gpkg", layer = "tlm_strassen_strasse")
stops <- read_sf("posmo_data/SWISSTLM3D_2023_LV95_LN02.gpkg", layer = "tlm_oev_haltestelle")
rail <- read_sf("posmo_data/SWISSTLM3D_2023_LV95_LN02.gpkg", layer = "tlm_oev_eisenbahn")
swiss <- read_sf("posmo_data/swissBOUNDARIES3D_1_4_TLM_LANDESGEBIET.shp")
canton <- read_sf("posmo_data/swissBOUNDARIES3D_1_4_TLM_KANTONSGEBIET.shp")
plot(canton)
plot(swiss)
...
st_write(intersect_roads,"posmo_data/intersect_roads.gpkg")

intersect_rail <- intersect_rail |> 
  select(c(objektart, auf_strasse, verkehrsmittel, geom))
st_write(intersect_rail,"posmo_data/intersect_rail.gpkg")

intersect_stops <- intersect_stops |> 
  select(c(objektart, name, geom))
st_write(intersect_stops,"posmo_data/intersect_stops.gpkg")
