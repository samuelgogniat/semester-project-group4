...
```{r, fig.align='center', fig.cap = "*figure 8: segments of the validation dataset correctly or incorrectly classified as tram by number of fixes attributed to tram rails as nearest feature*"}
#| warning: false
#| message: false
...
```{r, fig.align='center', fig.cap = "*figure 9: segment 352 (classified as walk) of the training data by manually validated transport mode: the transition from walk to bus did not lead to a segmentation during pre-processing*"}
#| warning: false
#| message: false
